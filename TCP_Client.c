...
void BroadcastReciever(){
	...
	broadcastPort = atoi("8080");   /* First arg: broadcast port */
...
int sock;                         /* Socket */
    ...
    broadcastPort = atoi("8080");    /* Second arg:  broadcast port */
...
int main(int argc, char *argv[]) { 
	...
	rc = pthread_create(&threads[2],NULL, BroadcastReciever, (void*)NULL);
	sleep(1); 
	printf("Please enter file name to search for: ");
	fgets(fileName,MAXLINE, stdin);
	strcpy(args2.fileName, fileName);
	args2.round = 2;
	rc = pthread_create(&threads[2],NULL, TCP_CALL, (void*)&args2);
	//}
